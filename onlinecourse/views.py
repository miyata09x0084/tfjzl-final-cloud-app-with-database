...
def show_exam_result(request, course_id, submission_id):
    ...
    total_score = 0
    questions = course.question_set.all()  # Assume questions related to the course

    for question in questions:
        correct_choices = question.choice_set.filter(is_correct=True)  # Get all correct choices for the question
        selected_choices = choices.filter(question=question)  # Get user's choices for the question
